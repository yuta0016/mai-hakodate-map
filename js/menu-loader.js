        ...
        <ul class="nav__list">
          ...
          <li class="nav__item nav__item--expandable">
            ...
            <ul class="nav__submenu" id="spots-menu">
              ...
              <li class="nav__subitem"><a href="${spotsPath}ramai.html" class="nav__sublink">Asian Bar RAMAI 函館店</a></li>
              <li class="nav__subitem"><a href="${spotsPath}goryonokura.html" class="nav__sublink">五稜乃蔵</a></li>
            </ul>
          </li>
